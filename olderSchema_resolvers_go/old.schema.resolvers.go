...
// 	user, err := r.UserService.GetByID(ctx, post.UserID)
// 	if err != nil {
// 		return nil, err
// 	}
...
// 	//so here is whare we will encounter the N+1 problem 
// 	// we wnat to get teh comments mentioned in the posts 
// 	// but internally in the graph ql schema we have also defined  ... that the comment has a post field inside i 
// 	//so if the user writes something like 

// 	/*

// 	query {
// 		post(id: "1") {
// 			comments {   ====>         //will hit commentResolver.post
// 			id
// 			post {
// 				id
// 			}
...
// 		}
// 	*/
// 	// 1. Query.post() executes once.
// 	// 2. Post.comments() executes once.
// 	// 3. Comment.post() executes once for EVERY comment.
// 	//
// 	// If there are 100 comments, Comment.post() will be called
// 	// 100 times, potentially executing the same database query
// 	// 100 times.
// 	//
// 	// This is the classic N+1 problem.
// 	//
// 	// We'll solve it later using DataLoaders, which batch and cache
// 	// requests so that all Comment.post() resolvers can be satisfied
// 	// with a single batched database query.


// 	//=====================================================
// 	//This is where we do batching and dataloader
// 	//=====================================================
...
// 	//DATALOADER Based implementataion 
